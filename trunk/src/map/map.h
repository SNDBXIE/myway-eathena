...
struct spawn_data {
	...
	unsigned int tombstone; // Tombstone (Tombstone) [Mark]
	struct {
...
enum _sp {
	...
	SP_ADD_HEAL_RATE,SP_ADD_HEAL2_RATE,SP_WMATK,SP_WMATK_RATE, //1090-1094
	...
	SP_FIXED_CASTRATE=3000, SP_FIXED_CAST, SP_VARIABLE_CASTRATE, SP_VARIABLE_CAST, SP_COOLDOWNRATE, SP_COOLDOWN, SP_SP_GAIN_RACE_ATTACK, SP_HP_GAIN_RACE_ATTACK, SP_EMATK, //3000-3008

	// Epoque's Expansion Pack 3050 - 3079
	SP_RACE=3050, SP_SCDURATION, SP_SCDAMAGE, SP_SCRESIST, SP_SCEXCHANGE, SP_ELEDAMAGE, SP_HPATKRATIO, SP_SPATKRATIO, SP_HPDRAINRATIO, SP_SPDRAINRATIO, 
	SP_MDEFATKRATIO_RC, SP_MDEFATKRATIO_ELE, SP_CRITICALDODGE, SP_CRITATKMISS, SP_MAXDAMAGE, SP_MINDAMAGE, SP_SKILLGAINSP, SP_NOSINGLEMAGIC, SP_NOAREAMAGIC, SP_SKILLTIME, SP_AREASKILL, 
	SP_AVOIDTRAP, SP_NOCONSUME, SP_MOVECAST, SP_HEALATTACK, SP_FULLDODGE, SP_LASTSTAND, SP_IGNOREGTB, SP_MAGICDAMAGERETURN2, SP_SPCOSTRATE, SP_SPCOST, SP_EXPDIFF, SP_DROPDIFF
};
...
//PVP Area by Mr.Postman
int map_check_pvp(int sid, int tid);
