...
#define MAX_SKILL_PRODUCE_DB	400
...
#define INF2_NOLP 0x4000 // Spells that can ignore Land Protector
...
int skill_renewal_castfix (struct block_list *bl, int skill_id, int skill_lv, int base_cast);//[malufett]
